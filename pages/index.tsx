    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <div className="d-flex justify-content-between align-items-center navbar-div-style">
        ...
        <div className="flex gap-[10px]">
          <button type="button" className="btn navbar-right-corner-btn-yellow">Upload CV</button>
          <button type="button" className="btn navbar-right-corner-btn-orange">Contact us</button>
        </div>
          ...
          <div className="d-flex flex-column gap-[30px] w-full">
            ...
            <div className="d-flex gap-[20px]">
              ...
              <div className="w-[24px] h-[24px] py-[4px] px-[1.54px] d-flex justify-content-center align-items-center">
                <svg width="21" height="17" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
