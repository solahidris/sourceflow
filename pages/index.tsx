    ...
    <div className="min-h-screen w-[1440px] bg-white text-black">
      ...
      <div className="clients-container-style">
        ...
        <div className="client-logo-container">
          <div><Image className="object-fit-contain" src="/microsoft.png" alt="next" width={181} height={30} /></div>
          ...
          <div><Image className="object-fit-contain" src="/cloudflare.png" alt="next" width={238} height={60} /></div>
          <div><Image className="object-fit-contain" src="/vmware.png" alt="next" width={160} height={53} /></div>
        </div>
      </div>
      ...
      <div className="footer-container-style">
        <div className="d-flex justify-content-between gap-[24px] w-full">

          <div className="d-flex flex-column gap-[30px] w-full">
            <span className="fw-bold text-[19px]">Software Recruitment co.</span>
            <div className="d-flex gap-[20px]">
              <div className="w-[22px] h-[24px]">
                <Link href="/"><svg width="22" height="21" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="w-[24px] h-[24px] p-[2px] d-flex justify-content-center align-items-center">
                <Link href="/"><svg width="20" height="20" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="w-[24px] h-[24px] py-[4px] px-[1.54px] d-flex justify-content-center align-items-center">
                <Link href="/"><svg width="21" height="17" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="d-flex flex-column gap-[30px] pr-[30px] w-full">
            ...
            <div className="d-flex flex-column gap-[20px] font-[400] text-white">
          ...
          <div className="d-flex flex-column gap-[30px] pr-[30px] w-full">
            ...
            <div className="d-flex flex-column gap-[20px] font-[400] ">
